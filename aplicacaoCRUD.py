...
class PrincipalBD:
    def __init__(self,win):
        ...
        self.treeProdutos = ttk.Treeview(win, collumns = self.dadosColunas, selectmode="browse")
        self.verscrlbar = ttk.Scrollbar(win, orien="vertical",command=self.treeProdutos.yview)
...
#Cadastrar Produtos----------------------------------------------------------------------------------
    ...
    def fCadastrarProduto(self):
        try:
            ...
            self.treeProdutos.insert(" ", iid=self.iid, values=(codigo, nome, preco))
            self.iid = self.iid +1
            self.id = self.id +1
            self.fLimparTela()
...
#Atualizar Produtos----------------------------------------------------------------------------------
    ...
    def fAtualizarProduto(self):
        try:
            ...
            self.carregarDadosIniciais()
            self.fLimparTela()
            print("Produgo Atualizado com Sucesso")
        except:
